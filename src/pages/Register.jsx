...
import { useHistory } from "react-router-dom";  // Para redirigir al usuario después del registro
...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (isRegistered) {
      history.push("/login");  // Si el registro es exitoso, redirigimos a la página de login
    }
  };
